Revisiting the bash scripting using [***Unix Programming Environment*** ](https://en.wikipedia.org/wiki/The_Unix_Programming_Environment)by ***[Brian W Kernighan](https://en.wikipedia.org/wiki/Brian_Kernighan).***
